...
# STANDARD STRING TEMPLATE (Not an f-string, preventing syntax errors entirely)
...
<div class="container">
  <header>
    <div class="header-top">
      <div><h1>PBTech Deals Filterer</h1><div class="scrape-time">Last updated: {SCRAPE_TIME}</div></div>
    ...
    <div class="quick-filter-menu-container" id="qsContainer">{QUICK_FILTERS}</div>
    {PROMO_FILTERS}
  </header>
...
<div id="whatsNewModal" class="modal-overlay" style="display: none;"><div class="modal-content"><div class="modal-header"><h2>What's New</h2><button id="closeWhatsNewBtn" style="border:none;background:none;font-size:20px;cursor:pointer">&times;</button></div><div class="modal-body">{WHATS_NEW}</div></div></div>
<script>
